...
- You MUST background every shell call, using `run_in_background` rather than a trailing `&`.
  Backgrounding also keeps the output out of context until you ask for it.
- Commands expected to run for over 10 seconds are the ones that need watching.
